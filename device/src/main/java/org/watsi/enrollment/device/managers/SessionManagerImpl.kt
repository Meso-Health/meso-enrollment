...
import org.watsi.enrollment.device.managers.SessionManager.Companion.ALLOWED_ROLES
...
class SessionManagerImpl(
    ...
    override fun shouldClearUserData(): Boolean {
        ...
        return previousUser != null && currentUser != null && previousUser != currentUser && previousUser.administrativeDivisionId != currentUser.administrativeDivisionId
    }
